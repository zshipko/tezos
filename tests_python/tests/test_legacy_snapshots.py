...
class TestLegacy:
    ...
    def test_generate_legacy_stores(self, legacy_stores, session):
        ...
        tmp = legacy_stores[f'from_rolling.rolling']
        session[f'from_rolling.rolling'] = tmp
    ...
    def test_bake_to_catch_up(self, sandbox, session):
